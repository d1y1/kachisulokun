...
1. `knowledge/stores/` と `knowledge/events/` を確認
2. プレイブックを参照:
...
3. 店舗の **X告知** と **みんレポ等の過去結果** を突合（当日情報は Web 検索）
4. 台番・末尾の癖は `knowledge/stores/` の観測ログを優先、なければデータサイトから考察
5. 推測は「確定 / 有力 / 可能性 / 不明」に分ける
6. 実践向けに「今日の仮説」と「観測ポイント」を短く返す
